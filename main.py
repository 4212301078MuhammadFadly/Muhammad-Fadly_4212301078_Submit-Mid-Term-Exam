...
FILE_PATH = r"D:\Muhammad Fadly\SEMESTER 5\Machine Vision\ATS_4212301078_Muhammad Fadly\data\emnist-letters-train.csv" 

# Jumlah sample (500 × 26 = 13.000)
...
plt.savefig('confusion_matrix_loocv_Muhammad Fadly.png')
print("Confusion Matrix plot saved as 'confusion_matrix_loocv_Muhammad Fadly.png'")
plt.show()